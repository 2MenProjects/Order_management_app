...
import packagePage
import accountPage as AccountPage
class MainPage:
    def __init__(self, shared_text="Phuc"):
        ...
        def about_Page():
            ...
            aboutPageLabel = Label(aboutPage,text="About Page",font=("Bold",20))
        ...
        def update_Page():
            ...
            updatePageLabel = Label(updatePage,text="Update Page",font=("Bold",20))
        ...
        def delivery_Page():
            ...
            deliveryPageLabel = Label(deliveryPage,text="Delivery Page",font=("Bold",20))
        ...
        #Menu items
        toggle_Menu_Btn = Button(menuBarFrame,image=toggle_Icon,bg=menuBarColor,border=0,activebackground=menuBarColor,command=extend_MenuBar)
        toggle_Menu_Btn.place(x=4,y=10)

        #Home
        home_Menu_Btn = Button(menuBarFrame,image=home_Icon,bg=menuBarColor,border=0,activebackground=menuBarColor,command=lambda : switch_Indication(home_Btn_Indicator,home_Page))
        ...
        home_Page_Label = Label(menuBarFrame,bg=menuBarColor,text="Home",fg="White",font=("Bold",15),anchor=W)
        home_Page_Label.place(x=45,y=130,width=100,height=40)
        home_Page_Label.bind("<Button-1>",lambda e: switch_Indication(home_Btn_Indicator,home_Page))

        #Account
        account_Menu_Btn = Button(menuBarFrame,image=account_Icon,bg=menuBarColor,border=0,activebackground=menuBarColor,command=lambda : switch_Indication(account_Btn_Indicator,account_Page))
        ...
        account_Page_Label = Label(menuBarFrame,bg=menuBarColor,text="Account",fg="White",font=("Bold",15),anchor=W)
        account_Page_Label.place(x=45,y=190,width=100,height=40)
        account_Page_Label.bind("<Button-1>",lambda e:switch_Indication(account_Btn_Indicator,account_Page))

        #Delivery
        delivery_Menu_Btn = Button(menuBarFrame,image=delivery_Icon,bg=menuBarColor,border=0,activebackground=menuBarColor,command=lambda : switch_Indication(delivery_Btn_Indicator,delivery_Page))
        ...
        delivery_Page_Label = Label(menuBarFrame,bg=menuBarColor,text="Delivery",fg="White",font=("Bold",15),anchor=W)
        delivery_Page_Label.place(x=45,y=250,width=100,height=40)
        delivery_Page_Label.bind("<Button-1>",lambda e: switch_Indication(delivery_Btn_Indicator,delivery_Page))

        #Update
        update_Menu_Btn = Button(menuBarFrame,image=update_Icon,bg=menuBarColor,border=0,activebackground=menuBarColor,command=lambda : switch_Indication(update_Btn_Indicator,update_Page))
        ...
        update_Page_Label = Label(menuBarFrame,bg=menuBarColor,text="Update",fg="White",font=("Bold",15),anchor=W)
        update_Page_Label.place(x=45,y=310,width=100,height=40)
        update_Page_Label.bind("<Button-1>",lambda e: switch_Indication(update_Btn_Indicator,update_Page))

        #About
        about_Menu_Btn = Button(menuBarFrame,image=about_Icon,bg=menuBarColor,border=0,activebackground=menuBarColor,command=lambda : switch_Indication(about_Btn_Indicator,about_Page))
        ...
        about_Page_Label = Label(menuBarFrame,bg=menuBarColor,text="About",fg="White",font=("Bold",15),anchor=W)
        about_Page_Label.place(x=45,y=370,width=100,height=40)
        about_Page_Label.bind("<Button-1>",lambda e: switch_Indication(about_Btn_Indicator,about_Page))
