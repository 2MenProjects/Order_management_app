...
class MainPage:
    def __init__(self, shared_text="Phuc"):
        ...
        # Driver
        driver_Menu_Btn = Button(menuBarFrame, image=account_Icon, bg=menuBarColor, border=0,
                                 activebackground=menuBarColor, command=lambda: switch_Indication(driver_Btn_Indicator, driver_Page))
        driver_Menu_Btn.place(x=9, y=250, width=30, height=40)

        driver_Btn_Indicator = Label(menuBarFrame, bg=menuBarColor)
        driver_Btn_Indicator.place(x=3, y=250, height=40, width=3)

        driver_Page_Label = Label(
            menuBarFrame, bg=menuBarColor, text="Tài xế", fg="White", font=("Bold", 15), anchor=W)
        driver_Page_Label.place(x=45, y=250, width=100, height=40)
        driver_Page_Label.bind(
            "<Button-1>", lambda e: switch_Indication(driver_Btn_Indicator, driver_Page))
        ...
        delivery_Menu_Btn.place(x=9, y=310, width=35, height=40)

        delivery_Btn_Indicator = Label(menuBarFrame, bg=menuBarColor)
        delivery_Btn_Indicator.place(x=3, y=310, height=40, width=3)

        delivery_Page_Label = Label(
            menuBarFrame, bg=menuBarColor, text="Vận chuyển", fg="White", font=("Bold", 15), anchor=W)
        delivery_Page_Label.place(x=45, y=310, width=110, height=40)
        ...
        update_Menu_Btn.place(x=9, y=370, width=30, height=40)

        update_Btn_Indicator = Label(menuBarFrame, bg=menuBarColor)
        update_Btn_Indicator.place(x=3, y=370, height=40, width=3)

        update_Page_Label = Label(menuBarFrame, bg=menuBarColor,
                                  text="Update", fg="White", font=("Bold", 15), anchor=W)
        update_Page_Label.place(x=45, y=370, width=100, height=40)
        ...
        about_Menu_Btn.place(x=9, y=430, width=30, height=40)

        about_Btn_Indicator = Label(menuBarFrame, bg=menuBarColor)
        about_Btn_Indicator.place(x=3, y=430, height=40, width=3)

        about_Page_Label = Label(menuBarFrame, bg=menuBarColor,
                                 text="About", fg="White", font=("Bold", 15), anchor=W)
        about_Page_Label.place(x=45, y=430, width=100, height=40)
